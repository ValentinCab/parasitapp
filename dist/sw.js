const CACHE='atlas-parasitologia-v24';
const CORE=['./','./index.html','./styles.css','./table-colors.css','./image-gallery.css','./app-v5.js?core=24','./data/seed-v2.json','./favicon.svg'];
