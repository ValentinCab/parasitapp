const CACHE='atlas-parasitologia-v25';
const CORE=['./','./index.html','./styles.css','./table-colors.css','./image-gallery.css','./app-v5.js?core=25','./data/seed-v2.json','./favicon.svg'];
